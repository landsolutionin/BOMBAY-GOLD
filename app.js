...
// ডায়মন্ড ফাটাফাট চার্টের অফলাইন পাতি ডাটা
const PATTI_DATA = {
...
// অফলাইন ওয়ার্ড ম্যাপিং ডাটা[cite: 3]
const WORD_MAPPING = {
...
// গেম বোর্ড ডাইনামিক রেন্ডারিং লুপ (২২ কলামের গ্রিড)[cite: 3]
function loadGameBoard() {
    ...
    BOARD_ROWS.forEach(row => {
        ...
        // ২২টি কলামের লুপ ঘুরিয়ে বক্স তৈরি[cite: 3]
        for(let i = 0; i < 22; i++) {
...
// বাজি ধরার অফলাইন নোড লজিক
function placeBet(rowLabel, colIndex, patti, word) {
    // যদি ইন্টারনেট না থাকে তবে বাজি ধরা যাবে না (লাল স্ক্রিন আটকা থাকবে)
    if (!navigator.onLine) {
        alert("সার্ভার কানেকশন নেই! বাজি ধরা সম্ভব নয়।");
        return;
    }
    console.log(`Bet Action -> Line: ${rowLabel}, Col: ${colIndex}, Pat: ${patti}, Wrd: ${word}`);
    alert(`আপনার বাজিটি কনফার্ম করুন:\nলাইন: ${rowLabel}\nপাতি: ${patti}\nওয়ার্ড: ${word}`);
}
...
function checkNetworkStatus() {
    ...
    if (navigator.onLine) {
        // ইন্টারনেট থাকলে গেম চলবে, লাল স্ক্রিন হাইড
        lockOverlay.style.display = 'none';
    } else {
        // ইন্টারনেট কেটে গেলেই এনিডেস্কের মতো লাল স্ক্রিন লক অন
        lockOverlay.style.display = 'flex';
    }
}

// প্রতি ১ সেকেন্ড পরপর নেটওয়ার্কের স্টেট চেক করার হার্টবিট লুপ
setInterval(checkNetworkStatus, 1000);

// ব্রাউজারের নিজস্ব নেটওয়ার্ক ইভেন্ট লিসেনার
